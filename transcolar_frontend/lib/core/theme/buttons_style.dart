...
import 'package:transcolar_app/core/services/responsive_service.dart'; // 🔥 ADICIONE ESTE IMPORT
import 'package:transcolar_app/core/theme/colors.dart';
...
class ButtonStyles {
  ...
  static ButtonStyle menuButton({bool isSelected = false}) {
    return ElevatedButton.styleFrom(
      backgroundColor: isSelected
          ? AppColors.amareloMel.withValues(alpha: 0.15) // 🔥 Fundo mais sutil
          : Colors.transparent,
      ...
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(8), // 🔥 Aumentado para 8
        side: BorderSide(
        ...
        Expanded(
          child: Text(
            ...
            style: TextStyle(
              ...
              fontFamily: 'LibreBaskerville', // 🔥 ADICIONADO
              color: isExit
                  ? AppColors.erro
                  : (isSelected ? AppColors.amareloMel : AppColors.branco),
            ),
  ...
  static ButtonStyle sairButton({bool isHovered = false}) {
    return ElevatedButton.styleFrom(
      backgroundColor: isHovered
          ? AppColors.erro.withValues(alpha: 0.2) // 🔥 Fundo vermelho suave
          : Colors.transparent,
      foregroundColor: isHovered ? AppColors.erro : AppColors.branco, // 🔥 Vermelho no hover
  ...
  // ======================= BOTÃO VERDE DE CADASTRO (TELA 2) =======================
  static ButtonStyle cadastroButton =
      ElevatedButton.styleFrom(
        backgroundColor: AppColors.amareloMel, // 🔥 AMARELO (como no logo)
        foregroundColor: AppColors.marromEscuro, // 🔥 TEXTO MARROM
        elevation: 4,
        shadowColor: AppColors.amareloMel.withValues(alpha: 0.3),
        padding: const EdgeInsets.symmetric(horizontal: 32, vertical: 12), // 🔥 MAIS LARGO
        minimumSize: const Size(200, 48), // 🔥 TAMANHO MÍNIMO
        shape: RoundedRectangleBorder(
        ...
        side: WidgetStateProperty.resolveWith<BorderSide>((
          ...
          if (states.contains(WidgetState.pressed)) {
            return BorderSide(
              color: AppColors.marromEscuro, // 🔥 BORDA MARROM
              width: 2.0,
            );
          }
  ...
  static ButtonStyle loginButton = cadastroButton.copyWith(
    backgroundColor: WidgetStateProperty.all(Colors.transparent), // 🔥 FUNDO TRANSPARENTE
    foregroundColor: WidgetStateProperty.all(AppColors.branco), // 🔥 TEXTO BRANCO
    side: WidgetStateProperty.all(
      const BorderSide(color: AppColors.branco, width: 2), // 🔥 BORDA BRANCA
    ),
    elevation: WidgetStateProperty.all(0),
  );

  // ======================= BOTÃO SALVAR (usa o cadastroButton existente) =======================
  static ButtonStyle get salvarButton => cadastroButton;
 
  // ======================= BOTÃO CANCELAR =======================
  static ButtonStyle cancelarButton =
      ElevatedButton.styleFrom(
  ...
  // ======================= BOTÃO LIMPAR =======================
  static ButtonStyle limparFormButton =
      ElevatedButton.styleFrom(
  ...
  // ======================= BOTÃO RESTAURAR =======================
  static ButtonStyle restaurarButton =
      ElevatedButton.styleFrom(
  ...
  // ======================= BOTÃO ÍCONE SALVAR =======================
  static ButtonStyle salvarIconButton =
      ElevatedButton.styleFrom(
        backgroundColor: AppColors.amareloMel, // 🔥 AMARELO
        foregroundColor: AppColors.marromEscuro,
        elevation: 4,
        shadowColor: AppColors.amareloMel.withValues(alpha: 0.3),
        padding: const EdgeInsets.all(12),
        minimumSize: const Size(50, 50),
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)), // 🔥 AUMENTADO
      ).copyWith(
        side: WidgetStateProperty.resolveWith<BorderSide>((
          Set<WidgetState> states,
        ) {
  ...
  static ButtonStyle cancelarIconButton =
      ElevatedButton.styleFrom(
        backgroundColor: AppColors.erro,
        foregroundColor: AppColors.branco,
        elevation: 4,
  ...
  // ======================= BOTÃO ÍCONE LIMPAR =======================
  static ButtonStyle limparIconButton =
      ElevatedButton.styleFrom(
        backgroundColor: AppColors.cinzaEscuro,
        foregroundColor: AppColors.branco,
        elevation: 4,
  ...
  static ButtonStyle restaurarIconButton =
      ElevatedButton.styleFrom(
        backgroundColor: AppColors.laranjaMel,
        foregroundColor: AppColors.branco,
        elevation: 4,
    ...
    return Tooltip(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(r.s(12)), // 🔥 AUMENTADO
          boxShadow: [
            BoxShadow(
              color: AppColors.amareloMel.withValues(alpha: 0.2), // 🔥 AMARELO
              blurRadius: 4,
        ...
        children: [
          Positioned(
            ...
            child: Icon(
              ...
              size: size * 0.80,
              color: AppColors.marromEscuro.withValues(alpha: 0.5), // 🔥 MARROM SUAVE
            ),
          ),
          Positioned(
            right: size * 0.00,
            ...
            child: Container(
              ...
              height: size * 0.42,
              decoration: BoxDecoration(
                color: AppColors.marromEscuro, // 🔥 MARROM
              ...
              child: Center(
                child: Icon(
                  Icons.add_rounded,
                  size: size * 0.28,
                  color: AppColors.amareloMel, // 🔥 AMARELO
                  weight: 900,
                ),
              ),
            ),
  ...
  static ButtonStyle filtrarButton =
      ElevatedButton.styleFrom(
  ...
  static ButtonStyle limparButton =
      ElevatedButton.styleFrom(
        backgroundColor: Colors.transparent,
        foregroundColor: AppColors.marromEscuro,
        elevation: 0,
  ...
  static Widget selecionarTudoButton({
    ...
    final String texto =
        label ?? (isAllSelected ? 'Desmarcar Tudo' : 'Selecionar Tudo');

    final IconData icone = isAllSelected
        ? Icons.check_circle
        : Icons.circle_outlined;

    final Color backgroundColor = isAllSelected
        ? AppColors.amareloMel
        : Colors.transparent;

    final Color foregroundColor = isAllSelected
        ? AppColors.marromEscuro
        : AppColors.marromEscuro;

    final Color borderColor = isAllSelected
        ? AppColors.amareloMel
        : AppColors.marromEscuro.withValues(alpha: 0.3);
