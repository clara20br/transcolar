// lib/features/home/presentation/layouts/screens/home_tablet.dart
...
class HomeTablet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Row(
        children: [
          // Menu lateral reduzido para tablet (pode ser recolhível)
          Container(
            width: 80, // Menu mais compacto para tablet
            child: MenuResponsivo(
              currentRoute: currentRoute,
              onMenuTap: onMenuTap,
              onExitTap: onExitTap,
              inDrawer: false,
              compactMode: true, // Você precisará adicionar esta flag no MenuResponsivo
            ),
          ),
          Expanded(
            child: Column(
